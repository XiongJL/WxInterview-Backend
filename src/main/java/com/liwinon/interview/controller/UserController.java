...
public class UserController {
	...
	public String saveName(String session_key,String userName) {
		System.out.println("saveNameModel 接收到的数据："+session_key+","+userName);
